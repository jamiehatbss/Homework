...
String decrypt(String scrambled, int shiftBy) {
  ...
  for (int i = 0; i < scrambled.length(); i++) {
    ...
    println("scrambled character is: " + scrambled.charAt(i));
    println("shifted character is: " + int(scrambled.charAt(i) - shiftBy));
    println("unscrambled character is: " + char(int(scrambled.charAt(i) - shiftBy)));  
}
